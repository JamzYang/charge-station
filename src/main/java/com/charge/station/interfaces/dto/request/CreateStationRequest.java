...
public record CreateStationRequest(
    ...
    @Size(max = 32, message = "运营商ID长度不能超过32字符")
    String operatorId,
     ...
     * @return CreateStationRequest实例
     */
    public static CreateStationRequest of(String name, String address, String description,
                                        BigDecimal latitude, BigDecimal longitude, String operatorId,
                                        LocalTime openTime, LocalTime closeTime) {
        return new CreateStationRequest(name, address, description, latitude, longitude, 
     ...
     * @return CreateStationRequest实例
     */
    public static CreateStationRequest of(String name, String address,
                                        BigDecimal latitude, BigDecimal longitude, String operatorId,
                                        LocalTime openTime, LocalTime closeTime) {
        return new CreateStationRequest(name, address, null, latitude, longitude, 
                                      operatorId, openTime, closeTime);
    }
}
